...
document.querySelector(".chatTitle h3 form").addEventListener("click",function(e){
    ...
    fetch("/chatrooms/"+chatroomID+"/name",{
        ...
        res.json().then((chatroom)=>{
            if (chatroom.error) err = true
               ...
               document.querySelector(".chatTitle h3 form").innerText = chatroom.name
            }
...
const setChatroomName = (chatroomID) => document.querySelector(".chatTitle h3 form").innerText = newTitle
